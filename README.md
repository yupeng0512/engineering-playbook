...
| 个人 Skills | 22 | 经验沉淀、批量沉淀编排、AI 工作流、头脑风暴、深度防御、系统调试、TDD 测试、投研报告、md2deck、**slidev-presentation**、**slidev-pitch-deck**、执行计划、UI/UX 设计 等 |
...
├── skills/
│   ├── personal/  (22 个: ai-workflow, article-tutor, brainstorming,
...
│   │    slidev-pitch-deck, slidev-presentation, system-debugging,
│   │    tech-review, ui-ux-pro-max, unittest, writing-plans, yt-dlp)
...
| 日期 | 变更 |
|------|------|
| 2026-02-25 | 新增 `slidev-presentation` + `slidev-pitch-deck` Skill：Markdown → Slidev 交互式演示文稿，含 Playwright MCP 自动化视觉验证 SOP |
