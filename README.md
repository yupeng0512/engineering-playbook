...
| 判断力卡片 | 3 | Agent 架构选型、简单性优先、杠杆交易风险决策 |
| 个人 Skills | 23 | 经验沉淀、批量沉淀编排、判断力锻造、AI 工作流、头脑风暴、深度防御、系统调试、TDD 测试、投研报告、md2deck、slidev-presentation、slidev-pitch-deck、执行计划、UI/UX 设计 等 |
...
├── skills/
│   ├── personal/  (23 个: ai-workflow, article-tutor, brainstorming,
