...
| 个人 Skills | 19 | 经验沉淀、AI 工作流、头脑风暴、深度防御、系统调试、TDD 测试、投研报告、**md2deck**、执行计划、UI/UX 设计 等 |
...
├── skills/
│   ├── personal/  (19 个: ai-workflow, article-tutor, brainstorming,
...
| 日期 | 变更 |
|------|------|
| 2026-02-25 | 新增 `md2deck` Skill：投研报告 Markdown → PPT 双引擎（Marp + python-pptx） |
