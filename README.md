...
| 可复用 Pattern | 9 | 动态配置串联、LLM JSON 清洗、幂等迁移、结构化 Prompt、仓库敏感信息防护、MCP Server 开发、SSE 流式 AI 客户端、数据管道监控、Stagehand 浏览器自动化 |
| 判断力卡片 | 8 | Agent 架构选型、简单性优先、上下文管理、工具设计、角色转变、止损优先、经济周期、身份元认知 |
| 个人 Skills | 24 | 经验沉淀、批量沉淀编排、判断力锻造、AI 工作流、头脑风暴、深度防御、系统调试、TDD 测试、投研报告、md2deck、slidev-presentation、slidev-pitch-deck、执行计划、UI/UX 设计、Stagehand 浏览器自动化 等 |
...
├── skills/
│   ├── personal/  (24 个: ai-workflow, article-tutor, brainstorming,
│   │    command-creator, cybernetics-loop, defense-in-depth, gongfeng-mr,
│   │    investment-research-report, judgment-forge, knowledge-base, md2deck,
│   │    playbook-onboarding,
